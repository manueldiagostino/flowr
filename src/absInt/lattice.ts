export interface Lattice<T> {
    ...
    /**
     * Performs the widening operation between `lhs` and `rhs`.
     * @param lhs - The left-hand side element.
     * @param rhs - The right-hand side element.
     * @returns The result of the widening operation between `lhs` and `rhs`.
     */
    widening(lhs: T, rhs: T): T;

    /**
     * Performs the narrowing operation between `lhs` and `rhs`.
     * @param lhs - The left-hand side element.
     * @param rhs - The right-hand side element.
     * @returns The result of the narrowing operation between `lhs` and `rhs`.
     */
    narrowing(lhs: T, rhs: T): T;
